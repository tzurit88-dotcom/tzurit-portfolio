...
export default function ProjectCard({ project, onClick }: ProjectCardProps) {
  return (
    <motion.div
      ...
      initial="initial"
      whileHover="hover"
      className="flex flex-col h-full group cursor-pointer bg-[#FDFCFA] border border-[#858E97]/35 rounded-2xl overflow-hidden hover:shadow-[0_12px_44px_rgba(50,64,79,0.06)] hover:border-[#1B232C]/30 transition-all duration-500"
    >
      <div className={cn(
      ...
      <div className="p-8 flex flex-col gap-4 min-h-[175px] bg-[#FDFCFA] border-t border-[#858E97]/25 transition-colors duration-300">
        <h2 className="text-2xl md:text-[28px] font-semibold tracking-tight text-[#1B232C] leading-snug">
          {project.title}
        </h2>
