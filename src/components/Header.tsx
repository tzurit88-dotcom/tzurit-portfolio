      ...
      >
        <div className="w-full flex items-center justify-between">
          ...
          >
            ...
            <span className="font-semibold text-[20px] lg:text-[22px] leading-none text-left text-[#1B232C]" style={{ fontFamily: "'Quicksand', sans-serif", letterSpacing: '0.02em' }}>
              Tzurit
            </span>
          </button>

          {/* Desktop Navigation */}
          <nav className="hidden md:flex items-center gap-4 text-[12px] uppercase tracking-[0.2em] font-medium text-[#1B232C]">
              ...
              {menuItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`transition-all duration-300 uppercase tracking-[0.2em] text-[12px] cursor-pointer border-none bg-transparent px-6 py-5 block text-[#1B232C] relative group ${
                  ...
                  >
                    <span className="relative py-1">
                      {item.label}
                      {!isActive && (
                        <span className="absolute -bottom-1 left-0 right-0 h-[1px] bg-[#1B232C] transition-transform duration-300 origin-left scale-x-0 group-hover:scale-x-100" />
                      )}
                    </span>
                  </button>
                );
            ...
            <motion.button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-[22px] h-[46px] bg-[#FDFCFA] hover:bg-[#858E97]/10 text-[#1B232C] border border-[#858E97]/40 rounded-full font-sans text-[16px] font-medium tracking-wide shadow-[0_2px_6px_rgba(50,64,79,0.1)] group cursor-pointer transition-all duration-300"
            >
              <span>contact</span>
              <motion.div
                variants={{ initial: { x: 0, y: 0 }, hover: { x: 2, y: 2 } }}
                transition={{ type: 'spring', stiffness: 350, damping: 15 }}
                className="text-[#858E97] group-hover:text-[#1B232C] flex items-center justify-center"
              >
          ...
          <div className="md:hidden flex items-center z-50">
            <button
              ...
              className="p-3 -mr-3 flex items-center justify-center cursor-pointer border-none bg-transparent text-[#1B232C] hover:opacity-70 transition-opacity"
          ...
          >
            <div className="flex flex-col py-6 px-10">
              <div className="flex flex-col space-y-2">
                {menuItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`text-[12px] uppercase tracking-[0.25em] font-semibold text-left py-4 w-full border-b border-neutral-100/50 hover:bg-neutral-50/50 px-2 rounded-sm transition-all text-[#1B232C] flex items-center justify-between ${
                        isActive ? 'opacity-100 font-bold bg-[#F5F4F0]/30' : 'opacity-70'
                      }`}
                    >
                      <span>{item.label}</span>
                      {isActive && <span className="w-1.5 h-1.5 rounded-full bg-[#1B232C]" />}
                    </button>
                  );
                })}
                <button
                ...
                >
                  <span>contact</span>
                  {currentView === 'contact' && <span className="w-1.5 h-1.5 rounded-full bg-[#1B232C]" />}
                </button>
              </div>
            </div>
          </motion.div>
        ...
        {isDrawerOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-0 bg-[#1B232C]/22 z-[100] cursor-pointer"
            />
            ...
            >
              ...
              <div className="p-6 border-b border-[#858E97]/15 flex items-center justify-between">
                <div>
                  <h2 className="text-4xl font-semibold text-[#1B232C] leading-none font-sans">
                    Contact
                  </h2>
                </div>
                <button
                  onClick={() => setIsDrawerOpen(false)}
                  className="p-2 rounded-full hover:bg-[#858E97]/10 text-[#858E97] hover:text-[#1B232C] transition-all cursor-pointer border-none bg-transparent"
              ...
              <div className="flex-1 flex flex-col items-center justify-center p-8 space-y-16">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="text-[#1B232C] hover:text-[#858E97] transition-colors duration-300 flex items-center justify-center"
