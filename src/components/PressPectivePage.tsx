...
export default function PressPectivePage({ project, onBack, onNavigate, onNavigateToProject }: PressPectivePageProps) {
  ...
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="min-h-screen bg-[#FDFCFA] text-[#1B232C] font-sans selection:bg-[#BEC2C6]/30"
    >
      ...
      <motion.button
        ...
        transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1] }}
        className="fixed left-6 md:left-12 z-40 group flex items-center gap-2 text-xs uppercase tracking-widest font-bold text-[#1B232C]/80 opacity-70 hover:opacity-100 transition-opacity px-3 py-2"
      >
      ...
      <main className="pt-44 pb-40">
        ...
        <section className="px-6 md:px-12 mb-20">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <motion.p 
              ...
              className="text-xl md:text-2xl font-light leading-relaxed text-[#1B232C]/75 max-w-2xl"
            >
        ...
        {/* Content Layers */}
        <div className="space-y-28 md:space-y-36 px-6 md:px-12 text-[#1B232C]/90">
          ...
          <section className="max-w-4xl mx-auto space-y-28">
            ...
            <div className="space-y-6">
              <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">Overview</h2>
              <div className="space-y-8">
                <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
          ...
          <section className="max-w-4xl mx-auto space-y-12 font-light">
            <div className="space-y-3">
              <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">The Problem</h2>
              <div className="space-y-8">
                <h3 className="text-2xl md:text-3xl font-light tracking-tight text-[#1B232C]/90">Curriculum vs. Engagement</h3>
                <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
                  Through a survey of 28 history teachers and 7 in-depth interviews, we surfaced three critical classroom tensions:
                </p>
                <div className="space-y-8 pt-4">
                  <div className="space-y-2">
                    <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90"><span className="font-bold">Shallow Comprehension:</span> Students memorize isolated dates and facts, failing to develop a deeper historical understanding.</p>
                  </div>
                  <div className="space-y-2">
                    <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90"><span className="font-bold">The Skill vs. Knowledge Trade-off:</span> Teachers lack the time and resources to teach higher-order thinking skills, and worry that prioritizing them will jeopardize curriculum coverage - their primary evaluation metric.</p>
                  </div>
                  <div className="space-y-2">
                    <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90"><span className="font-bold">The Engagement Gap:</span> Capturing and maintaining student attention in text-heavy history lessons is a constant uphill battle.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8 pt-4">
              <h3 className="text-2xl md:text-3xl font-light tracking-tight text-[#1B232C]/90">The Strategic Framework</h3>
              <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">To address these challenges, we defined three core pillars to guide the design of our solution:</p>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-8">
                 <div className="bg-[#E5E6E6]/20 rounded-3xl p-6 border border-[#BEC2C6]/25 space-y-2">
                   <div className="font-semibold text-[#1B232C]">Higher-Order Skill Development</div>
                   <p className="font-[370] leading-relaxed text-[#1B232C]/90">Focusing on critical thinking, deep questioning, and multi-perspective analysis.</p>
                 </div>
                 <div className="bg-[#E5E6E6]/20 rounded-3xl p-6 border border-[#BEC2C6]/25 space-y-2">
                   <div className="font-semibold text-[#1B232C]">Core Knowledge Acquisition</div>
                   <p className="font-[370] leading-relaxed text-[#1B232C]/90">Driving deep, contextual understanding rather than shallow memorization.</p>
                 </div>
                 <div className="bg-[#E5E6E6]/20 rounded-3xl p-6 border border-[#BEC2C6]/25 space-y-2">
                   <div className="font-semibold text-[#1B232C]">Engaging Experience</div>
                   <p className="font-[370] leading-relaxed text-[#1B232C]/90">Creating a motivating, active learning environment.</p>
                 </div>
              </div>
            </div>
          </section>
          ...
          <section className="max-w-4xl mx-auto space-y-12">
            <div className="space-y-12">
              ...
              <div className="space-y-6 pt-6 font-light">
                <div className="space-y-6">
                  <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">MVP Testing & Insights</h2>
                  <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">The first MVP featured a "Story" format (text and imagery) followed by a Q&A session. Testing this early version in three classrooms provided two critical insights:</p>
                </div>
                <ul className="space-y-4">
                  <li className="flex gap-4">
                    <span className="font-bold text-[#1B232C]/60">01.</span>
                    <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90"><span className="font-bold">Shift in Focus:</span> Survey and interview feedback revealed lukewarm motivation and low learning perception. However, a pattern emerged: students drifted off during the initial reading, but became noticeably more engaged during the question-asking phase.</p>
                  </li>
                  <li className="flex gap-4">
                    <span className="font-bold text-[#1B232C]/60">02.</span>
                    <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90"><span className="font-bold">User Need:</span> Both teachers and students repeatedly asked for "the other side of the story," suggesting a need for comparative analysis.</p>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-12 pt-4">
              <div className="space-y-2">
                <span className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C] block">The Pivot</span>
                <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
          ...
          <section className="max-w-4xl mx-auto space-y-12 md:space-y-16">
            <div className="space-y-3">
              ...
              <h3 className="text-2xl md:text-3xl font-light tracking-tight text-[#1B232C]/90">Designing the Experience</h3>
            </div>
            ...
            <div className="space-y-20 md:space-y-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-y-10 md:gap-x-12 lg:gap-x-16 items-center">
                <div className="md:col-span-5 space-y-6">
                  <div className="space-y-2">
                    <h4 className="text-xl font-semibold text-[#1B232C]/85">1. The Journalistic Metaphor</h4>
                  </div>
                  <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-y-10 md:gap-x-12 lg:gap-x-16 items-center">
                <div className="md:col-span-5 space-y-6 order-1 md:order-2">
                  <div className="space-y-2">
                    <h4 className="text-xl font-semibold text-[#1B232C]/85">2. The Preparation Phase (Question Notepad)</h4>
                  </div>
                  <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-y-10 md:gap-x-12 lg:gap-x-16 items-center">
                <div className="md:col-span-5 space-y-6">
                  <div className="space-y-2">
                    <h4 className="text-xl font-semibold text-[#1B232C]/85">3. The Dual-Perspective Interview Room</h4>
                  </div>
                  <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-y-10 md:gap-x-12 lg:gap-x-16 items-center">
                <div className="md:col-span-5 space-y-6 order-1 md:order-2">
                  <div className="space-y-2">
                    <h4 className="text-xl font-semibold text-[#1B232C]/85">4. Gamification & Quality Feedback</h4>
                  </div>
                  <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-y-10 md:gap-x-12 lg:gap-x-16 items-center">
                <div className="md:col-span-5 space-y-6">
                  <div className="space-y-2">
                    <h4 className="text-xl font-semibold text-[#1B232C]/85">5. Teacher Control Panel</h4>
                  </div>
                  <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
          ...
          <section className="max-w-4xl mx-auto space-y-12">
            <div className="space-y-6">
              <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">Impact & Outcomes</h2>
              <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
                The platform was tested across three pilot rounds involving 8 classes, approximately 160 students, and 6 teachers - delivering <strong className="font-bold text-[#1B232C]/60">higher-than-expected</strong> results in student motivation, core knowledge acquisition, and higher-order thinking skills.
              </p>
            </div>
            ...
            <div className="space-y-12">
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 relative">
                  {[
                    <span>The school principal and coordinators all came to the class and were amazed by the <span className="font-bold text-[#1B232C] underline decoration-[#BEC2C6] underline-offset-4 not-italic">meaningful learning</span> taking place.</span>,
                    <span>The lesson officially ended, but the students just <span className="font-bold text-[#1B232C] underline decoration-[#BEC2C6] underline-offset-4 not-italic">didn’t want to leave for recess</span>.</span>,
                    <span>I noticed a <span className="font-bold text-[#1B232C] underline decoration-[#BEC2C6] underline-offset-4 not-italic">significant jump in grades</span> compared to subjects taught without the platform. Their writing, vocabulary, and historical understanding improved dramatically.</span>,
                    <span><span className="font-bold text-[#1B232C] underline decoration-[#BEC2C6] underline-offset-4 not-italic">Students</span> from other classes asked to join, <span className="font-bold text-[#1B232C] underline decoration-[#BEC2C6] underline-offset-4 not-italic">parents</span> wanted to buy the platform, and <span className="font-bold text-[#1B232C] underline decoration-[#BEC2C6] underline-offset-4 not-italic">teachers</span> from other subjects asked for a similar tool.</span>
                  ].map((quote, idx) => (
                    <div 
                      key={idx} 
                    ...
                    >
                      <Quote 
                        className="absolute -top-4 -right-4 text-[#1B232C]/[0.03]" 
                        size={120} 
                        fill="currentColor"
                        stroke="none"
                      />
                      <p className="text-xl md:text-2xl font-light italic leading-relaxed text-[#1B232C]/90 relative z-10">
                        "{quote}"
                      </p>
               ...
               <div className="space-y-6 font-light pt-8">
                  <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">Market Validation</h2>
                  <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
      ...
      <AnimatePresence>
        {selectedImage && (
          ...
          >
            ...
            >
              <X size={24} className="text-[#1B232C]" />
            </motion.button>
