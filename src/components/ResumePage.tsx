          ...
          <div className="flex flex-row items-center justify-between border-b border-[#e0e0e0] pb-6 mb-12 gap-4 print:hidden">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#1B232C] hover:bg-[#1B232C]/90 text-[#FDFCFA] rounded-full text-xs font-medium tracking-wide transition-all cursor-pointer"
              >
