  ...
  const ArrowButton = ({ onClick, children }: { onClick: (e: React.MouseEvent) => void; children: React.ReactNode }) => (
    <button
      ...
      className="w-10 h-10 rounded-full bg-[#FDFCFA] border-2 border-black/10 flex items-center justify-center
                 hover:scale-110 active:scale-95 transition-all text-[#1B232C]/40 hover:text-[#1B232C] z-20 shrink-0"
    >
      {children}
    </button>
  );
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0 flex items-center justify-between">
              <h2 className="text-3xl md:text-5xl font-light tracking-tight text-[#1B232C]/90">System Overview</h2>
            ...
            {(isPressPective
              ...
              <button
                ...
                className={`
                  ...
                  ${viewMode === mode.value
                    ? 'bg-[#1B232C] text-[#FDFCFA]'
                    : 'text-[#1B232C]/40 hover:text-[#1B232C]/60 bg-transparent'}
                `}
              >
            ...
            <div ref={headerRef} className="px-5 py-3 flex items-center justify-between">
              <AnimatePresence mode="wait">
                <motion.p
                  ...
                  className="text-[14px] font-medium text-[#1B232C]"
                >
                  {currentTitle || ' '}
                </motion.p>
              </AnimatePresence>
              <span className="text-[11px] text-[#1B232C]/25 font-medium shrink-0 ml-4">
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="absolute top-3 right-3 w-8 h-8 rounded-full bg-[#FDFCFA]/90 shadow-md
                                    flex items-center justify-center text-[#1B232C]/60
        ...
        {displayImages.map((_, i) => (
          <button
            ...
            className={`h-1.5 transition-all duration-300 rounded-full ${
              i === currentIndex ? 'w-7 bg-[#1B232C]/60' : 'w-2 bg-[#BEC2C6]/30'
            }`}
          />
        ))}
      </div>
