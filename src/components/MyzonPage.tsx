...
export default function MyzonPage({ project, onBack, onNavigate, onNavigateToProject }: MyzonPageProps) {
          ...
          >
            ...
            <div className="flex flex-col gap-1.5 mb-2">
              <div className="flex items-center gap-1">
                <h4 className="text-[10px] sm:text-[11px] font-bold tracking-tight text-[#1B232C]">Products</h4>
                        ...
                        {row.active ? (
                          <div className="flex justify-end items-center relative">
                            ...
                            <div className="absolute right-[-4px] bottom-[-6px] pointer-events-none z-50">
                              <svg className="w-3.5 h-3.5 text-[#1B232C] filter drop-shadow-sm" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <motion.div 
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="min-h-screen bg-[#FDFCFA] text-[#1B232C] font-sans selection:bg-neutral-150"
    >
      ...
      <motion.button
        ...
        transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1] }}
        className="fixed left-6 md:left-12 z-40 group flex items-center gap-2 text-xs uppercase tracking-widest font-bold text-[#1B232C] opacity-70 hover:opacity-100 transition-opacity px-3 py-2"
      >
      ...
      <main className="pt-44 pb-40">
        ...
        <section className="px-6 md:px-12 mb-20">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <motion.p 
              ...
              className="text-xl md:text-2xl font-light leading-relaxed text-[#1B232C]/75 max-w-3xl"
            >
              {project.description}
            </motion.p>
        ...
        <div className="space-y-24 md:space-y-32 px-6 md:px-12 text-[#1B232C]/90">
          ...
          <section className="max-w-4xl mx-auto space-y-12 font-light">
            <div className="space-y-6">
              <h2 className="text-2xl md:text-3xl font-semibold text-[#1B232C] tracking-tight">Background</h2>
              <p className="text-lg font-light leading-relaxed text-[#1B232C]">
          ...
          <section className="max-w-4xl mx-auto space-y-12 font-light">
            <div className="space-y-6">
              <h2 className="text-2xl md:text-3xl font-semibold text-[#1B232C] tracking-tight">The Problem</h2>
              <p className="text-lg font-light leading-relaxed text-[#1B232C]">
          ...
          <section className="max-w-4xl mx-auto space-y-12 font-light">
            <div className="space-y-6">
              <h2 className="text-2xl md:text-3xl font-semibold text-[#1B232C] tracking-tight">The Solution</h2>
              <p className="text-lg font-light leading-relaxed text-[#1B232C]">
                ...
                <div className="space-y-6">
                  <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 pb-4">
                    <div className="flex flex-col gap-1">
                      <h2 className="text-base md:text-lg font-medium text-[#1B232C] tracking-tight">{sec.tag}</h2>
                    </div>
                  </div>
