  ...
  return (
    ...
    >
      ...
      <main className="pt-44 pb-16">
        ...
        {/* Content Layers */}
        <div className="space-y-28 md:space-y-36 px-6 md:px-12 text-[#1B232C]/90 font-light leading-relaxed">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 max-w-4xl mx-auto">
            <div className="space-y-6">
              <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">Challenge</h2>
              <div className="space-y-4">
                <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
            ...
            <div className="space-y-6">
              <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">Solution</h2>
              <div className="space-y-4">
                <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
          ...
          <section className="max-w-4xl mx-auto space-y-12">
            <div className="space-y-6">
              <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">My Role & Scope</h2>
              <div className="space-y-6">
                <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
          ...
          <section className="max-w-4xl mx-auto space-y-12">
            <div className="space-y-6">
              <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">Guiding Principles</h2>
              <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">The following core principles guided the design of the interfaces:</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="bg-[#E5E6E6]/20 rounded-3xl p-6 border border-[#BEC2C6]/25 space-y-2">
                  <div className="font-semibold text-[#1B232C]">Lecturer Interface</div>
                  <p className="font-[370] leading-relaxed text-[#1B232C]/90">Providing total control over the content, while reducing uncertainty regarding what students see on their end.</p>
                </div>
                <div className="bg-[#E5E6E6]/20 rounded-3xl p-6 border border-[#BEC2C6]/25 space-y-2">
                  <div className="font-semibold text-[#1B232C]">Student Interface</div>
                  <p className="font-[370] leading-relaxed text-[#1B232C]/90">Reducing cognitive load and encouraging steady progress through the learning material.</p>
                </div>
              </div>
          </section>
          ...
          <section className="max-w-4xl mx-auto space-y-16">
            <div className="space-y-3">
              <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">The Lecturer Surface</h2>
              <h3 className="text-2xl md:text-3xl font-light text-[#1B232C]/90">Bridging the gap between AI automation and pedagogical intent.</h3>
            </div>
          ...
          <section className="max-w-4xl mx-auto space-y-16">
            <div className="space-y-3">
              <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">The Student Surface</h2>
              <h3 className="text-2xl md:text-3xl font-light text-[#1B232C]/90">Supporting various learning modes and utilizing "Nudges" to encourage engagement.</h3>
            </div>
            ...
            <div className="space-y-20 md:space-y-24">
               <div className="space-y-8">
                  <div className="space-y-6">
                    ...
                    <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">The AI assistant adapts its behavior based on the lesson stage: it answers freely during instruction, switches to "Tutor Mode" (guiding the student without revealing the answer) during interactive challenges, and is disabled during assessments.</p>
                    {/* Toggle */}
                    <button
                      onClick={() => setShowTutorMode(v => !v)}
                      className="flex items-center gap-3 cursor-pointer group"
                    >
                      <div className={`relative w-11 h-6 rounded-full transition-colors duration-300 ${showTutorMode ? 'bg-[#1B232C]' : 'bg-[#BEC2C6]/50'}`}>
                      ...
                      <span className="text-sm font-medium text-[#1B232C]/70 group-hover:text-[#1B232C] transition-colors">Show Tutor mode</span>
                    </button>
                  </div>
                  <div
                    className="w-full rounded-2xl overflow-hidden border border-[#BEC2C6]/60 group relative cursor-zoom-in"
               ...
               <div className="space-y-8">
                  <div className="space-y-6">
                    ...
                    <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">Encouraging language and color-coded status badges (e.g., "Catch Up" in orange) help students orient themselves within the schedule without creating unnecessary stress.</p>
                  </div>
                  <div
                    className="w-full rounded-2xl overflow-hidden border border-[#BEC2C6]/60 group relative cursor-zoom-in"
          ...
          <section className="max-w-4xl mx-auto space-y-16">
            <div className="space-y-3">
              <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">Mobile Adaptability - 1</h2>
              <h3 className="text-2xl md:text-3xl font-light tracking-tight text-[#1B232C]/90">The Persistent Feedback Bar</h3>
            </div>
              <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
          ...
          <section className="max-w-4xl mx-auto space-y-12">
            <div className="space-y-3">
              <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">Mobile Adaptability - 2</h2>
              <h3 className="text-2xl md:text-3xl font-light tracking-tight text-[#1B232C]/90">Chat & Engagement</h3>
            </div>
            ...
            <div className="flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-x-16 md:gap-y-0 md:mb-[-1.5rem]">
               <div className="space-y-2">
                 ...
                 <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">The mobile screen only had room for the lesson slide (text and image). However, to nudge students to ask questions, the team agreed the AI chat must remain highly accessible.</p>
               </div>
               <div className="space-y-2">
                 <span className="text-[10px] font-bold opacity-40 uppercase tracking-widest block">Solution</span>
                 <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">Contained the chat within a top action button, using an icon and clear microcopy to actively invite engagement.</p>
               </div>
               ...
               <div className="space-y-2 md:min-h-[160px]">
                 ...
                 <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">The mobile chat drawer could not fit both the soft keyboard and the suggested questions simultaneously.</p>
               </div>
               <div className="space-y-2 md:min-h-[160px]">
                 <span className="text-[10px] font-bold opacity-40 uppercase tracking-widest block">Solution</span>
                 <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">Placed the suggested questions inside their own drawer, designed to be open by default.</p>
               </div>
            </div>
          ...
          <section className="max-w-4xl mx-auto space-y-8">
            <h2 className="text-xs uppercase tracking-[0.15em] font-bold text-[#1B232C]">Outcome</h2>
            <p className="text-lg font-[370] leading-relaxed text-[#1B232C]/90">
